    ...
    return (
      <>
        ...
        <article>
          ...
          <p>
            I wrote my first lines of code at the age of 13, driven by the desire to solve small daily problems with technology. By age 14, I had already dedicated a large part of my day to programming. Since then, coding became more than just a skill, it became my passion and career.
          </p>
          <p>
